                        ...
                        >
                            ...
                            <div class="sm:flex sm:items-start">
                                ...
                                >
                                    ...
                                    <button
                                        class="relative inline-flex items-center justify-center p-4 px-6 py-2 overflow-hidden font-medium text-lime-600 transition duration-300 ease-out border-2 border-lime-500 rounded-full shadow-md group"
                                    >
                                        <span
                                            class="absolute inset-0 flex items-center justify-center w-full h-full text-white duration-300 -translate-x-full bg-lime-500 group-hover:translate-x-0 ease"
                                        >
                                            <box-icon
                                                name="check"
                                                size="md"
